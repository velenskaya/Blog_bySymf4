 ...
 */
final class Version20180530164339 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contact_request CHANGE email email VARCHAR(25) DEFAULT NULL, CHANGE phone_number phone_number INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE contact_request CHANGE email email VARCHAR(50) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE phone_number phone_number INT NOT NULL');
